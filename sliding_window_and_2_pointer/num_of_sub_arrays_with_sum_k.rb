...
# OPTIMZED - sum is changing at every index and at every index we are checking how many (sum - k) are existing in prefix_sum (prefix_sum is a map of sum vs its frequency)
